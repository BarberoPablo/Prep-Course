...
function arrayContiene(array, elemento) {
  ...
  for(var i = 0; i < array.length && !pertenece; i++){
    pertenece = array[i] == elemento;
  }
...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  var product = (arguments.length == 0) ? 0 : arguments[0];
...
function todosIguales(arreglo) {
  ...
  for(var i = 1; i < arreglo.length && todosIguales; i++){
    todosIguales = (arreglo[i] == numero);
  }
